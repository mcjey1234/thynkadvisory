(function() {
    var widgetHandler = function($scope, $) {
        ...
        var mainSwiperOptions = {
            observer: !0,
            observeParents: !0,
            direction: String(elementSettings[dceDynamicPostsSkinPrefix + 'direction_slider']) || 'horizontal',
            initialSlide: slideInitNum,
            reverseDirection: Boolean(elementSettings.rtl),
            speed: Number(elementSettings[dceDynamicPostsSkinPrefix + 'speed_slider']) || 300,
            autoHeight: Boolean(elementSettings[dceDynamicPostsSkinPrefix + 'autoHeight']),
            ...
            slidesPerGroup: Number(elementSettings[dceDynamicPostsSkinPrefix + 'slidesPerGroup']) || 1,
            slidesPerColumn: Number(elementSettings[dceDynamicPostsSkinPrefix + 'slidesColumn']) || 1,
            spaceBetween: Number(elementSettings[dceDynamicPostsSkinPrefix + 'spaceBetween']) || 0,
            slidesOffsetBefore: Number(elementSettings[dceDynamicPostsSkinPrefix + 'slidesOffsetBefore']) || 0,
            slidesOffsetAfter: Number(elementSettings[dceDynamicPostsSkinPrefix + 'slidesOffsetAfter']) || 0,
            slidesPerColumnFill: String(elementSettings[dceDynamicPostsSkinPrefix + 'slidesPerColumnFill']) || 'row',
            centerInsufficientSlides: !0,
            centeredSlides: centeredSlides,
            centeredSlidesBounds: Boolean(elementSettings[dceDynamicPostsSkinPrefix + 'centeredSlidesBounds']),
            grabCursor: Boolean(elementSettings[dceDynamicPostsSkinPrefix + 'grabCursor']),
            ...
            pagination: {
                ...
                renderFraction: function(currentClass, totalClass) {
                    if (!Boolean(elementSettings.rtl)) {
                        return '<span class="' + currentClass + '"></span>' + '<span class="separator">' + String(elementSettings[dceDynamicPostsSkinPrefix + 'fraction_separator']) + '</span>' + '<span class="' + totalClass + '"></span>'
                    }
                    return '<span class="' + totalClass + '"></span>' + '<span class="separator">' + String(elementSettings[dceDynamicPostsSkinPrefix + 'fraction_separator']) + '</span>' + '<span class="' + currentClass + '"></span>'
                },
            ...
            scrollbar: {
                ...
                hide: Boolean(elementSettings[dceDynamicPostsSkinPrefix + 'scrollbar_hide']),
                draggable: Boolean(elementSettings[dceDynamicPostsSkinPrefix + 'scrollbar_draggable']),
                snapOnRelease: !0,
            },
